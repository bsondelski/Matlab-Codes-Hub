function [err] = errorGenBackwards(T_H_in,T_H_out,T_C_in,p_H,p_C,m_dot_H,m_dot_C,UA,fluid_C,fluid_H,mode,N)
...
[~,~,h_H_in]=getPropsTP(T_H_in,p_H,fluid_H,mode,1); %hot side inlet enthalpy
...
[~,~,h_C_max]=getPropsTP(T_H_in,p_C,fluid_C,mode,1);  %find max possible enthalpy for cold side

if h_C_out>(h_C_max+50)
