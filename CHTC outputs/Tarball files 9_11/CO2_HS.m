% CO2_HS Help file for the CO2_HS MEX-file.
%
% Calculates fluid properties of carbon dioxide at the thermodynamic state defined
% by the provided specific enthalpy (H, in kJ/kg) and specific entropy (S, in kJ/kg-K).
%
% The calling syntax is:
% 
%   [prop1, prop2, ...] = CO2_HS(H, S, 'prop1', 'prop2', ...)
%
...
%
% Enthalpy and entropy (H and S) can be scalars or N-dimensional arrays.  The property values
...
% thermodynamic state.  Likewise, calling this function once with an array of enthalpy
% and entropy values will be faster than iterating over a loop in MATLAB and calling
% this function multiple times with scalar enthalpy and entropy values.
%
%
