% CO2_PH Help file for the CO2_PH MEX-file.
%
% Calculates fluid properties of carbon dioxide at the thermodynamic state
% defined by the provided pressure (P, in kPa) and specific enthalpy (H, in kJ/kg).
%
% The calling syntax is:
% 
%   [prop1, prop2, ...] = CO2_PH(P, H, 'prop1', 'prop2', ...)
%
...
%
% Pressure and enthalpy (P and H) can be scalars or N-dimensional arrays.  The property values
...
% and enthalpy values will be faster than iterating over a loop in MATLAB and calling
% this function multiple times with scalar pressure and enthalpy values.
%
%
