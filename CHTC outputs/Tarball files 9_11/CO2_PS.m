% CO2_PS Help file for the CO2_PS MEX-file.
%
% Calculates fluid properties of carbon dioxide at the thermodynamic state
% defined by the provided pressure (P, in kPa) and specific entropy (S, in kJ/kg-K).
%
% The calling syntax is:
% 
%   [prop1, prop2, ...] = CO2_PS(P, S, 'prop1', 'prop2', ...)
%
...
%
% Pressure and entropy (P and S) can be scalars or N-dimensional arrays.  The property values
...
% this function multiple times with scalar pressure and entropy values.
%
%
