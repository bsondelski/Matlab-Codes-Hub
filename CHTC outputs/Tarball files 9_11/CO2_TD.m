% CO2_TD Help file for the CO2_TD MEX-file.
%
% Calculates fluid properties of carbon dioxide at the thermodynamic state
% defined by the provided temperature (T, in K) and density (D, in kg/m3).
%
% The calling syntax is:
% 
%   [prop1, prop2, ...] = CO2_TD(T, D, 'prop1', 'prop2', ...)
%
...
%
% Temperature and density (T and D) can be scalars or N-dimensional arrays.  The property values
...
% and density values will be faster than iterating over a loop in MATLAB and calling
% this function multiple times with scalar temperature and density values.
%
%
