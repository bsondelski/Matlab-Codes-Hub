% CO2_TP Help file for the CO2_TP MEX-file.
%
% Calculates fluid properties of carbon dioxide at the thermodynamic state
% defined by the provided temperature (T, in K) and pressure (P, in kPa).
%
% The calling syntax is:
% 
%   [prop1, prop2, ...] = CO2_TP(T, P, 'prop1', 'prop2', ...)
%
...
%
% Temperature and pressure (T and P) can be scalars or N-dimensional arrays.  The property values
...
% thermodynamic state.  Likewise, calling this function once with an array of temperature
% and pressure values will be faster than iterating over a loop in MATLAB and calling
% this function multiple times with scalar temperature and pressure values.
%
%
