% CO2_TQ Help file for the CO2_TQ MEX-file.
%
% Calculates fluid properties of carbon dioxide at the thermodynamic state
% defined by the provided temperature (T, in K) and quality (Q, from 0 to 1).
%
% The calling syntax is:
% 
%   [prop1, prop2, ...] = CO2_TQ(T, Q, 'prop1', 'prop2', ...)
%
...
%
% Temperature and quality (T and Q) can be scalars or N-dimensional arrays.  The property values
...
% this function multiple times with scalar temperature and quality values.
%
%
