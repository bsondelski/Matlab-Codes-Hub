% CO2_UD Help file for the CO2_UD MEX-file.
%
% Calculates fluid properties of carbon dioxide at the thermodynamic state
% defined by the provided internal energy (U, in kJ/kg) and density (D, in kg/m3).
%
% The calling syntax is:
% 
%   [prop1, prop2, ...] = CO2_UD(U, D, 'prop1', 'prop2', ...)
%
...
%
% Specific internal energy and density (U and D) can be scalars or N-dimensional arrays.  The property
% values returned by this function will have the same size and shape as the inputs, which must match if
...
% thermodynamic state.  Likewise, calling this function once with an array of internal
% energy and density values will be faster than iterating over a loop in MATLAB and
% calling this function multiple times with scalar internal energy and density values.
%
%
