...
elseif logns<-0.8392
    ...
    eff_max=0.695455-1.47518*logns+0.0529263*logns^2+21.3801*logns^3+56.9767*logns^4+58.1086*logns^5+20.8809*logns^6;
end
...
elseif logns<-1
    ...
    middle=0.369142-0.629575*logns-0.381976*logns^2-1.73486*logns^3-0.991895*logns^4+1.07147*logns^5+0.813393*logns^6;
end

eff_balj_max=0.904586624844687;                     %max efficiency from balje curves
eff_new_max=0.904586624844687;                      %max efficiency according to newer designs
...
if d_s==inf
    ...
    elseif logns<-1
        ...
        stdeviation=0.165216-0.39868*logns-4.93956*logns^2-26.6755*logns^3-58.8628*logns^4-56.5442*logns^5-19.7513*logns^6;
    end
