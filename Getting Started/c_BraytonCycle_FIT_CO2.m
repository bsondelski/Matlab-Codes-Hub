% file to test setup of Matlab Codes for Brayton Cycle code using FIT for
% pure CO2
...
% 1. Install FIT matlab toolbox to your computer
...
RecupMatl = 'SN';
fluid = 'CO2';
mode = 2;           % sets fluid property mode to FIT
