function [net_power,cyc_efficiency,D_T,D_c,Ma_T,Ma_c,Anozzle,q_reactor,q_rad,T1,Power_T,Power_c,HEXeffect,energy,m_dotcycle] = SpecifiedPower(power,p1,T4,PR_c,UA,A_panel,T_amb,fluid,mode)
...
if a==0
    ...
    [net_power,cyc_efficiency,D_T,D_c,Ma_T,Ma_c,Anozzle,q_reactor,q_rad,T1,Power_T,Power_c,HEXeffect,energy] = BraytonCycle(m_dotcycle,p1,T4,PR_c,UA,A_panel,T_amb,fluid,mode);
end
...
if a==2
    ...
    for t=1:20
        ...
        [net_powermax(t),~,~,~,~,~,~,~,~,~,~,~,~,~]=BraytonCycle(m_dot2(t),p1,T4,PR_c,UA,A_panel,T_amb,fluid,mode);
    end
