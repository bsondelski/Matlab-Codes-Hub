function [m_dotError] = specifiedPowerError(m_dot_guess,power,p1,T4,PR_c,UA,A_panel,T_amb,fluid,mode)
...
[net_power,~,~,~,~,~,~,~,~,~,~,~,~,~]=BraytonCycle(m_dot_guess,p1,T4,PR_c,UA,A_panel,T_amb,fluid,mode);
m_dotError=power-net_power;
