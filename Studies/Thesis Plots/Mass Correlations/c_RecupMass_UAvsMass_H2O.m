...
% updated values 4/7/2019
mass_550C = [1.16, 5.78];
mass_550Cline = 0.42*UA_vec-0.52;


figure(2)
l2 = plot(UA,mass_550C,'-ob','MarkerSize',10);
hold on
% l2 = plot(UA,mass_650C,'-*k','MarkerSize',10);
% l3 = plot(UA,mass_750C,'-sk','MarkerSize',15);

plot(UA_vec,mass_550Cline,'-b')
...
%%%%%%%%%%%%%%water%%%%%%%%%%%%%%%%%%%%%%%
mass_550C = [4.87, 18.87];
mass_550Cline = 1.272727*UA_vec-0.220909;
l4 = plot(UA,mass_550C,'-sb','MarkerSize',10);

mass_550Cline1 = mass_550Cline(UA_vec<4);
mass_550Cline2 = mass_550Cline(UA_vec>15);
plot(UA_vec1,mass_550Cline1,'-b',UA_vec2,mass_550Cline2,'-b')
%%%%%%%%%%%%%%water%%%%%%%%%%%%%%%%%%%%%%%


legend([l3,l1,l4,l2],'CO_2 - Far Term Stainless','CO_2 - Inconel','H_2O - Far Term Stainless','H_2O - Inconel','location','northwest')
xlabel('UA [kW/K]','fontsize',18)
ylabel('Recuperator Mass [kg]','fontsize',18)
grid on