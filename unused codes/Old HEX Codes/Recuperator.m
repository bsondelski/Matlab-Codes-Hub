function [T_H_out, T_C_out] = Recuperator(T_H_in,T_C_in,p_H,p_C,m_dot_H,m_dot_C,UA,substance,mode)
%
...
for i=1:N
    ...
    epsilon(i)=q_dot/(N*C_dot_min(i)*(T_H(i)-T_C(i+1)));      %effectiveness of sub HEX [qdot(in subHEX)/qdot_max]
